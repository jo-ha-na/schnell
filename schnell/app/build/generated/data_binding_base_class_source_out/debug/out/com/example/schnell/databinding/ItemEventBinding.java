...
public final class ItemEventBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnModifyDate;
  ...
  private ItemEventBinding(@NonNull LinearLayout rootView, @NonNull Button btnModifyDate,
      @NonNull TextView textViewEventDate, @NonNull TextView textViewEventDescription,
      @NonNull TextView textViewEventName) {
    this.rootView = rootView;
    this.btnModifyDate = btnModifyDate;
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btnModifyDate;
      Button btnModifyDate = ViewBindings.findChildViewById(rootView, id);
      if (btnModifyDate == null) {
        break missingId;
      }
      ...
      return new ItemEventBinding((LinearLayout) rootView, btnModifyDate, textViewEventDate,
